...
using Leave_Management_DotNetCore.Data;

namespace Leave_Management_DotNetCore.Controllers
{
    public class LeaveTypesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,DefaultDays,Id,CreatedDate,ModifiedDate")] LeaveType leaveType)
        {
            if (id != leaveType.Id)
            {
                return NotFound();
